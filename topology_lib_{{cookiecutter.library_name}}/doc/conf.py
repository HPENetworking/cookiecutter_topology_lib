...
from topology_lib_{{ cookiecutter.library_name }} import __version__
...
htmlhelp_basename = 'topology_lib_{{ cookiecutter.library_name }}doc'
...
latex_documents = [
    (
        'index', 'topology_lib_{{ cookiecutter.library_name }}.tex',
...
man_pages = [
    (
        'index',
        'topology_lib_{{ cookiecutter.library_name }}',
        '{{ cookiecutter.project_name }} Documentation',
        [author], 1
    ),
]
...
autoapi_modules = {
    'topology_lib_{{ cookiecutter.library_name }}': None
}
